...
export class AbstractAmpContext {
  ...
  setupMetadata_(metadata) {
    ...
    this.ampcontextFilepath = contextState.ampcontextFilepath;
    this.ampcontextVersion = contextState.ampcontextVersion;
    this.canary = contextState.canary;
    this.canonicalUrl = contextState.canonicalUrl;
    this.clientId = contextState.clientId;
    this.container = contextState.container;
    this.domFingerprint = contextState.domFingerprint;
    this.hidden = contextState.hidden;
    this.initialIntersection = contextState.initialIntersection;
    this.initialLayoutRect = contextState.initialLayoutRect;
    this.pageViewId = contextState.pageViewId;
    this.referrer = contextState.referrer;
    this.sentinel = contextState.sentinel;
    this.sourceUrl = contextState.sourceUrl;
    this.startTime = contextState.startTime;
    this.tagName = contextState.tagName;
